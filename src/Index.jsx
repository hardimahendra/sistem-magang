  ...
  return (
    <>
      <div className="flex justify-center items-center w-[100vw] h-[100vh] bg-gray-600">
        <div className="w-[70%] h-[80%] flex justify-center items-center bg-no-repeat bg-[url('/img/bg-unsika.png')] rounded-lg shadow-lg">
          <div className="flex flex-col items-center gap-10">
            ...
            <div className="flex justify-around items-center w-full">
              ...
              <Link className="bg-gray-500 text-white p-2 px-4 rounded-sm hover:bg-green-500" to="/regis" type="button">
                Daftar
              </Link>
            </div>
          </div>
