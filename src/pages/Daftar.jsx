      ...
      <div className="container">
        <div className="content-magang">
          <div className="form-content">
            ...
            <div>
              <h6 className="fw-bold">Tahap Persiapan Magang</h6>
              <div>
                <i className="fas fa-caret-right"></i>
            ...
            <div>
              <h6 className="fw-bold">Tahap Pelaksanaan Magang</h6>
              <div>
                <i className="fas fa-caret-right"></i>
            ...
            <div>
              <h6 className="fw-bold">Tahap Pelaporan Magang</h6>
              <div>
                <i className="fas fa-caret-right"></i>
          ...
          <div className="form-content">
            ...
            <div>
              <h6 className="fw-bold">Tahap Persiapan Magang Tipe Kompetisi</h6>
              <div>
                <i className="fas fa-caret-right"></i>
            ...
            <div>
              <h6 className="fw-bold">Tahap Pelaksanaan Magang Tipe Kompetisi</h6>
              <div>
                <i className="fas fa-caret-right"></i>
